...
const Home = ({ navigate, allowedAreas = [] }) => {
    const showAll = allowedAreas.length === 0;
    const showIP = showAll || allowedAreas.includes('ip');
    const showPI = showAll || allowedAreas.includes('pi');
